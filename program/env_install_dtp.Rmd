...
# インストール
RStudio Desktopのインストール自体は対話的に進めれば問題なくインストールできます。[こちら <i class="fa fa-external-link"></i>](https://support.rstudio.com/hc/en-us/articles/206569407-Older-Versions-of-RStudio){target="_blank" title="RStudio"}からプラットフォームに見合ったファイルをダウンロードしてください。
　  
