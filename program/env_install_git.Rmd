...
![](./fig/git/Git_for_Winodws_01.png)

　  

2) コンポーネントの選択は任意ですがRStudioやGUIクライアントで利用する場合はミニマムで構いません

![](./fig/git/Git_for_Winodws_02.png)

　  

3) （ソース）エディタはお好みのエディタを指定してください

![](./fig/git/Git_for_Winodws_03_1.png)
...
![](./fig/git/Git_for_Winodws_04.png)
...
![](./fig/git/Git_for_Winodws_05.png)

　  

6) 改行設定は何も変換しない"Checkout as-is, commit as-is"を選択しておきます

![](./fig/git/Git_for_Winodws_06.png)
...
![](./fig/git/Git_for_Winodws_07.png)
...
![](./fig/git/Git_for_Winodws_08.png)

　  

9) インストールが開始されます

![](./fig/git/Git_for_Winodws_09.png)

　  

10) これでインストーラは終了です

![](./fig/git/Git_for_Winodws_10.png)
...
![](./fig/git/SmartGit_02.png)

　  

3) デスクトップアイコンは任意で、他のオプションはデフォルトのままでも構いません

![](./fig/git/SmartGit_03.png)

　  

4) インストール設定を確認します

![](./fig/git/SmartGit_04.png)

　  

5) インストールの設定を確認したらインストールを開始します

![](./fig/git/SmartGit_05.png)

　  

6) インストールが開始されます

![](./fig/git/SmartGit_06.png)

　  

7) これでインストールは終了です

![](./fig/git/SmartGit_07.png)

　  

## 初期設定
[SmartGit <i class="fa fa-external-link"></i>][SmartGit]のインストールが完了し[SmartGit <i class="fa fa-external-link"></i>][SmartGit]が起動すると最初に初期設定のためのダイアログが表示されますので、手順にしたがって初期設定をおこないます。なお、初期設定では[GitHub][GitHub]などのホスティング・サービスのアカウントは取得していなくても問題ありません。  
　  

1) ライセンス種別の確認

![](./fig/smartgit/smartgit_01.png)
...
![](./fig/smartgit/smartgit_03-1.png)
...
![](./fig/smartgit/smartgit_03-2.png)
...
![](./fig/smartgit/smartgit_06-1.png)
...
Windows環境において[GitHub <i class="fa fa-external-link"></i>][GitHub]を利用する場合には[GitHub <i class="fa fa-external-link"></i>][GitHub]が提供している[GitHub Desktop (旧GitHub for Windows) <i class="fa fa-external-link"></i>][GitHubDesktop]を選択する手もあります。  
[GitHub <i class="fa fa-external-link"></i>][GitHub]謹製ですので[GitHub <i class="fa fa-external-link"></i>][GitHub]を利用するには最適です。
