...
# パッケージのインストール
チュートリアルではRStudioと以下のパッケージが必要となりますので事前に[RStudioのインストール](./install_dtp.html)ならびに以下を参考に[DT][DT], [formatR][formatR], [knitr][knitr], [learnr][learnr], [rmarkdown][rmarkdown], [shiny][shiny], [tidyverse][tidyverse]パッケージをインストールして下さい。なお、バージョン情報等については[こちら](../basics/index.html)で確認して下さい。  
　  
...
![Install Packages RStudio](./fig/install_pkg_rstudio_02.png)
...
[DT]: https://cran.r-project.org/web/packages/DT/index.html "DT"
[formatR]: https://cran.r-project.org/web/packages/formatR/index.html "formatR"
[knitr]: https://cran.r-project.org/web/packages/knitr/index.html "knitr"
[learnr]: https://cran.r-project.org/web/packages/learnr/index.html "learnr"
[rmarkdown]: https://cran.r-project.org/web/packages/rmarkdown/index.html "rmarkdown"
[shiny]: https://cran.r-project.org/web/packages/shiny/index.html "shiny"
[tidyverse]: https://cran.r-project.org/web/packages/tidyverse/index.html "tidyverse"
