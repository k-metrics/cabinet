...
file_path <- "/home/sampo/Dropbox/RStudio/cabinet/program/data/odc.csv"
# file_path <- "C:\\Users\\suzuki\\Dropbox\\RStudio\\cabinet\\program\\data\\odc.csv"
odc_data <- read_csv(file_path, locale = locale(encoding = "CP932"), progress = FALSE)

file_path <- "/home/sampo/Dropbox/RStudio/cabinet/program/data/issues.csv"
# file_path <- "C:\\Users\\suzuki\\Dropbox\\RStudio\\cabinet\\program\\data\\issues.csv"
