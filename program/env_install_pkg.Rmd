...
![CRANミラーの選択](./fig/pkg/Rcmdr_Install_02.jpg)
...
![Linux環境のGUIモードでのインストール](./fig/pkg/r_gui_pkg_linux.png)
...
![Install Pkg w/ RStudio](./fig/pkg/install_pkg_rstudio.png)
...
category | パッケージのカテゴリ                                   | 現状未使用なので項目ごと省略可
omit     | リストには残したいがインストールしたくない場合のフラグ | `y`でインストールしない
rep      | パッケージのあるリポジトリ                             | CRANは記述省略可、他は未対応
memo     | 備考用                                                 | 省略可
