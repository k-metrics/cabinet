...
# インストール
[Rtools <i class="fa fa-external-link"></i>](https://cran.r-project.org/bin/windows/Rtools/){target="_blank" title="CRAN"}から利用している[R <i class="fa fa-external-link"></i>][R]のバージョンにあったバイナリをダウンロードしてインストールして下さい。32bit版と64bit版が同梱されていますので環境に応じて選択して下さい。  
　  
