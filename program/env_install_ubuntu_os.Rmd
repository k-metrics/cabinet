...
* 後述のRStudioの日本語入力パッチは**_16.04LTS用_**で、他のバージョンでは利用できません
* **_18.04LTS_**ではデフォルトのインプットメソッドであるIBusを利用すればRStudioで日本語入力ができるそうです
* **_18.04LTSでFcitx_**を使いたい場合は**_18.04LTS用_**の日本語入力パッチを適用してください
