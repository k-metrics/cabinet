...
MacやWindows環境では[SourceTree <i class="fa fa-external-link"></i>](https://www.sourcetreeapp.com/){target="_blank" title="Free Git GUI for Mac and Windows"}が有名ですがUbuntu環境では利用できませんので、以下から好みに応じて選択してください。Ubuntu環境以外にMacやWindows環境を利用する場合はGUI環境を統一しておくことをおすゝめします。  
