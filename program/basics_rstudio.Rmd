...
## 注意点
[RStudio <i class="fa fa-external-link"></i>][RSD]は日本語を始めとしたいわゆるマルチバイト文字（現在はユニコードが主流になりつつあるので表現としては不適切ですが）の扱いが不得手です。特にWindows以外の環境での利用や[R Markdown <i class="fa fa-external-link"></i>][RM]の利用を前提として以下の条件で利用するように心がけてください。  
