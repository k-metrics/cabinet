...
----------|----------------------------------------------------------|---
e1071     | Misc Functions of the Department of Statistics           | [CRAN <i class="fa fa-external-link"></i>][e1071]
moments   | Moments, cumulants, skewness, kurtosis and related tests | [CRAN <i class="fa fa-external-link"></i>][moments]
nortest   | Test for Normality                                       | [CRAN <i class="fa fa-external-link"></i>][nortest]
tidyverse | Easily Install and Load the 'Tidyverse'                  | [CRAN <i class="fa fa-external-link"></i>][tidyverse]
qqplotr   | Quantile-Quantile Plot Extensions for 'ggplot2'          | [CRAN <i class="fa fa-external-link"></i>][qqplotr]
...
歪度と尖度を用いた検定もありますが、ここでは省略します。検定の関数は[**`moments`**パッケージ <i class="fa fa-external-link"></i>][moments]などに実装されています。  
...
### コルモゴロフ-スミノフ検定
二つの標本を比較するノンパラメトリック検定。"KS検定"と略される場合もあり、標本数が大きい場合に向いていると言われています。標本数の目安としては2,000を目安にしてシャピロ-ウィルク検定と切り替える[統計ソフト <i class="fa fa-external-link"></i>](http://www.jmp.com/japan/support/faq/stat_2085.shtml){target="_blank" title="SAS Institute Inc."}もあります。  
$$H_0 : \mbox{二つの分布は等しい}$$  
```{r}
...
* [分布型の確認と正規性の検定 <i class="fa fa-external-link"></i>](https://qiita.com/uri/items/e656f90e9dda342c54bb){target="_blank" title="Qiita"}
* [アンダーソン-ダーリング検定 <i class="fa fa-external-link"></i>](https://goo.gl/xPUHwo){target="_blank" title="Wikipedia"}  

<!-- https://ja.wikipedia.org/wiki/%E3%82%A2%E3%83%B3%E3%83%80%E3%83%BC%E3%82%BD%E3%83%B3%E2%80%93%E3%83%80%E3%83%BC%E3%83%AA%E3%83%B3%E3%82%B0%E6%A4%9C%E5%AE%9A)  -->
...
[e1071]: https://cran.r-project.org/web/packages/e1071/ {target="_blank" title="Misc Functions of the Department of Statistics, Probability Theory Group (Formerly: E1071), TU Wien"}
[moments]: https://cran.r-project.org/web/packages/moments/ {target="_blank" title="Moments, cumulants, skewness, kurtosis and related tests"}
[nortest]: https://cran.r-project.org/web/packages/nortest/ {target="_blank" title="Tests for Normality"}
[tidyverse]: https://cran.r-project.org/web/packages/tidyverse/ {target="_blank" title="Easily Install and Load the 'Tidyverse'"}
[qqplotr]: https://cran.r-project.org/web/packages/qqplotr/ {target="_blank" title="Quantile-Quantile Plot Extensions for 'ggplot2'"}
