...
[シフトJISを使い続ける上場企業をまとめてみた <i class="fa fa-external-link"></i>](https://www.megamouth.info/entry/2017/10/20/015056){target="_blank" title="megamouthの葬列"} を参考に`UTF-8`のサイトをチェックしてみると
