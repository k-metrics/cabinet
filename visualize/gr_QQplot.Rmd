...
QQプロットは二つの確率変数の分布を比較する際に使われるグラフで、横軸に観測値の期待値、縦軸に観測値を取る確率プロットです。縦軸と横軸が逆の場合もあります。  
一般的に正規分布ににしたがっているかを確認するために使われるので正規QQプロットと呼ばれることもありますが、期待値自体は任意の確率分布を適用できますので、正規分布以外の分布にそくしているかを見ることもできます。  
　  
...
* [正規確率プロット, 統計WEB](https://bellcurve.jp/statistics/glossary/2061.html)
* [Q-Q plot, Cook for R](http://www.cookbook-r.com/Graphs/Q-Q_plot/)
* [qqplotr, RDocumentation](https://www.rdocumentation.org/packages/qqplotr/versions/0.0.2)  
