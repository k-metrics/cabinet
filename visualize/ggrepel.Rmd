...
# 参考資料
* [`ggrepel` Package Vignettes <i class="fa fa-external-link"></i>](https://cran.r-project.org/web/packages/ggrepel/vignettes/ggrepel.html){target="_blank" title="ggreple Usage Example"}
