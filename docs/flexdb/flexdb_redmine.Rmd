...
<<<<<<< HEAD:flexdb/redmine_flexdb.Rmd
    orientation: columns
=======
    navbar:
      - { title: "Prev", icon: "fa-chevron-circle-left", href: "./flexdb.html"}
    orientation: columns
    self_contained: true
    social: [ "menu" ]
    storyboard: true
>>>>>>> feature/update/flexdb:docs/flexdb/flexdb_redmine.Rmd
...
=======
load("./data/redmine_issues_all_1114.RData")
>>>>>>> feature/update/flexdb:docs/flexdb/flexdb_redmine.Rmd
...
# Defect
=======
# Defect {data-navmenu="Open-Close"}
>>>>>>> feature/update/flexdb:docs/flexdb/flexdb_redmine.Rmd
...
# Feature
=======
# Feature {data-navmenu="Open-Close"}
>>>>>>> feature/update/flexdb:docs/flexdb/flexdb_redmine.Rmd
...
# Category List
=======
# Category List {data-navmenu="Misc"}
>>>>>>> feature/update/flexdb:docs/flexdb/flexdb_redmine.Rmd
```{r}
issues_2018 %>% 
